    ...
    return (
        <aside style={{
            ...
            <div style={{ padding: "10px 8px", flex: 1, overflow: "hidden auto" }}>
                ...
                <NavItem
                    active={selectedCollection === null && !showFavoritesOnly}
                    onClick={onSelectAll}
                ...
                <div style={{
                    ...
                    <span style={{ fontSize: 9, fontWeight: 700, color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.12em" }}>
                        Collections
                    </span>
                    <button
                    ...
                    >
                        {editingCollection === c.id ? (
                            <div style={{ display: "flex", gap: 4, padding: "4px 4px" }}>
                                <select
                                    value={c.icon}
                                    onChange={e => onUpdateCollection(c.id, c.name, e.target.value)}
                                    style={{
                                        width: 34, background: "var(--surface-2)", border: "1px solid var(--border)",
                                        borderRadius: 5, fontSize: 13, color: "var(--text)", cursor: "pointer",
                                    }}
                                >
                                ...
                                <input
                                    ...
                                    style={{
                                        ...
                                        borderRadius: 5, padding: "3px 7px", fontSize: 12, color: "var(--text)",
                                        outline: "none",
                                    }}
                                />
                            </div>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    color: selectedCollection === c.id ? "var(--accent)" : "var(--text-soft)",
                                    fontSize: 13,
                                }}
                            ...
                            >
                                ...
                                <span style={{
                                    ...
                                    whiteSpace: "nowrap", fontWeight: selectedCollection === c.id ? 600 : 400,
                                }}>
                                    {c.name}
                                </span>
                                <span style={{ fontSize: 11, color: selectedCollection === c.id ? "var(--accent)" : "var(--text-muted)", flexShrink: 0 }}>
                                    {getLinksInCollection(c.id)}
                                </span>
                                    ...
                                    >
                                        <span
                                            ...
                                            style={{
                                                ...
                                                color: "var(--text-muted)", cursor: "pointer", transition: "color .1s",
                                            }}
            ...
            <div style={{ padding: "8px 12px 12px", borderTop: "1px solid var(--border)" }}>
                ...
                <button
                    ...
                    style={{
                        ...
                        color: "var(--text-muted)", fontSize: 12, fontWeight: 500, transition: "all .12s",
                    }}
